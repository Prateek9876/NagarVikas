    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(AppLocalizations.of(context)
            .get('strayAnimalsIssueTitle')), // Localized string
        backgroundColor: const Color.fromARGB(255, 4, 204, 240),
        foregroundColor: Colors.black,
        elevation: 1,
      ),
      body: SharedIssueForm(
        // Removed const as it's no longer a const constructor
        issueType: AppLocalizations.of(context)
            .get('strayAnimalsIssueType'), // Localized string
